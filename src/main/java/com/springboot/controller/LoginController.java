...
//		}
		System.out.println("result   "+authority);
	...
	public String test(@RequestBody String body, HttpServletRequest req) {
		JSONObject obj = JSONObject.fromObject(body);
		String toke = obj.get("token").toString();
		System.out.println("token:"+toke);
		Claims claims = JWTUtil.parseToken(toke, "MDk4ZjZiY2Q0NjIxZDM3M2NhZGU0ZTgzMjYyN2I0ZjY="); 
